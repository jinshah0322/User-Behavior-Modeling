    ...
    return (
        <section className="cart-items">
            ...
            <div className="lg:flex gap-16">
                <section className="w-[70%] lg:grid lg:grid-cols-1 md:grid-cols-2 sm:grid sm:grid-cols-2 sm:gap-4 sm:w-[90%]">
                    {
                                ...
                                <div key={index}>
                                    <div className="grid justify-between items-center border border-[#eee] rounded-md w-full my-2 py-6 ml-8">
                                        <div className="lg:flex items-center w-full">
                                            ...
                                            <div className="lg:max-w-[350px] lg:min-w-[350px] max-w-[200px] min-w-[200px] lg:ml-4 ml-3 p-3">
