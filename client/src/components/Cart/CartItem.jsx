...
const CartItem = ({setCurrent,setIsAddress}) => {
    ...
    return (
        <section className="cart-items">
            ...
            <div className="lg:flex gap-16">
                                ...
                                <div key={index}>
                                    <div className="grid justify-between items-center border border-[#eee] rounded-md w-full my-2 py-6 ml-8">
                                        <div className="lg:flex items-center w-full">
                                            ...
                                            <div className="lg:max-w-[350px] lg:min-w-[350px] max-w-[200px] min-w-[20px] ml-4">
                                                <h1 className="text-xl font-semibold overflow-hidden whitespace-nowrap overflow-ellipsis">{item?.title}</h1>
                                                <p className="text-gray-500">Price: ₹ {item?.price}</p>
                                            </div>
                                            <div className="ml-8 lg:flex items-center justify-center lg:max-w-full max-w-[140px]">
                                                <div className={`flex items-center justify-center border px-4 py-2 ${loading?"bg-gray-200":""}`}>
                                                ...
                                                <span className="text-black font-semibold ml-8">{loading?<Spin />:`₹ ${item.subtotal}`}</span>
                ...
                <section className="border lg:w-[23%] mt-2">
