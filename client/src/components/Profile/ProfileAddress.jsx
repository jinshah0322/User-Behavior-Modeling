...
const ProfileAddress = () => {
    ...
    useEffect(() => {
        if (formData.streetAddress === formDataone.streetAddress && formData.city === formDataone.city && formData.state === formDataone.state && formData.country === formDataone.country && formData.postalcode === formDataone.postalcode) {
            setIsEdited(false)
        }
        else {
            setIsEdited(true)
    ...
    const updateProfile = async () => {
        if (formData.streetAddress === '' || formData.city === '' || formData.state === '' || formData.country === '' || formData.postalcode === '' || !stateSelected || !citySelected) {
    ...
    useEffect(() => {
        State.getStatesOfCountry(formData?.country).length > 0 ? setIsStateSelected(true) : setIsStateSelected(false)
        City.getCitiesOfState(formData?.country, formData?.state).length > 0 ? setIsCitySelected(true) : setIsCitySelected(false)
